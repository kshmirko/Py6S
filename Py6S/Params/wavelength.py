...
class PredefinedWavelengths:
    ...
    MODIS_412 = (15, 0.4000, 0.435, 
                 np.array([0.0051, 0.0820, 0.5233, 
                           0.6240, 0.7567, 0.5177, 0.8406, 0.9080, 0.3372, 0.0320, 0.0060, 0.0022, 0.0007, 0.0006, 0.0004, 0.0003]))

    MODIS_443 = (16, 0.4200, 0.4600, 
                 np.array([0.0002, 0.0005, 0.0012, 
                           0.0031, 0.0075, 0.0190, 
                           0.0970, 0.5133, 0.9250, 
                           1.0000, 0.9415, 0.3912, 
                           0.0367, 0.0048, 0.0010, 
                           0.0002, 0.0000]))

    MODIS_469 = (17, 0.4500, 0.4850, 
                 np.array([0.0000, 0.0272, 0.1966, 
                           0.6654, 0.9863, 0.9370, 
                           0.8539, 0.8739, 0.9213, 
                           0.8586, 0.5903, 0.2140, 
                           0.0300, 0.0000, 0.00]))

    MODIS_488 = (18, 0.4700, 0.5000, 
                 np.array([0.0021, 0.0041, 0.0089, 
                           0.0196, 0.0972, 0.5859, 
                           0.9602, 0.9896, 0.9888, 
                           0.5968, 0.0398, 0.0062, 
                           0.0027]))
                           
    MODIS_531 = (19, 0.5100, 0.5500, 
                 np.array([0.0007, 0.0014, 0.0028, 
                           0.0059, 0.0121, 0.1904, 
                           0.6861, 0.9849, 0.9980, 
                           0.9309, 0.7034, 0.2541, 
                           0.0205, 0.0067, 0.0036, 
                           0.0019, 0.0010]))
                           
    MODIS_551 = (20, 0.5300, 0.5600, 
                 np.array([0.0014, 0.0033, 0.0082, 
                           0.0211, 0.1623, 0.5715, 
                           0.9713, 0.9915, 0.8736, 
                           0.5087, 0.0771, 0.0090, 
                           0.0054]))
                           
    MODIS_555 = (21, 0.5300, 0.5800, 
                 np.array([0.0000, 0.0000, 0.0000, 
                           0.0000, 0.0401, 0.2438, 
                           0.6520, 0.9458, 0.9961, 
                           0.9906, 0.9857, 0.9783, 
                           0.9321, 0.7058, 0.3157, 
                           0.0518, 0.0000, 0.0000, 
                           0.0000, 0.0000,0]))
                           
    MODIS_645 = (22, 0.6000, 0.6900, 
                 np.array([0.0000, 0.0000, 0.0000, 
                           0.0000, 0.0000, 0.0000, 
                           0.0281, 0.1446, 0.3770, 
                           0.6375, 0.7699, 0.7807, 
                           0.7870, 0.7904, 0.7976, 
                           0.8100, 0.8240, 0.8373, 
                           0.8587, 0.8920, 0.9195, 
                           0.9632, 0.9938, 0.9978, 
                           0.9568, 0.8340, 0.7227, 
                           0.5770, 0.3988, 0.2215, 
                           0.0985, 0.0442, 0.0156, 
                           0.0000, 0.0000, 0.0000,0]))
                           
    MODIS_667 = (23, 0.6500, 0.6900, 
                 np.array([0.0009, 0.0026, 0.0077, 
                           0.0417, 0.3263, 0.7915, 
                           0.9999, 0.8940, 0.6867, 
                           0.2809, 0.0144, 0.0043, 
                           0.0016, 0.0006, 0.0002, 
                           0.0001,0]))
                           
    MODIS_678 = (24, 0.6550, 0.7100, 
                 np.array([0.0012, 0.0014, 0.0017, 
                           0.0038, 0.0083, 0.0342, 
                           0.1875, 0.5859, 0.9337, 
                           0.9913, 0.9333, 0.6279, 
                           0.2286, 0.0257, 0.0087, 
                           0.0041, 0.0019, 0.0009, 
                           0.0004, 0.0003, 0.0002, 
                           0.0002,0]))
                           
    MODIS_748 = (25, 0.7200, 0.7700, 
                 np.array([0.0008, 0.0012, 0.0016, 
                           0.0020, 0.0024, 0.0053, 
                           0.0127, 0.0285, 0.1904, 
                           0.5833, 0.9291, 0.9923, 
                           0.7789, 0.3782, 0.0555, 
                           0.0100, 0.0040, 0.0016, 
                           0.0006, 0.0003, 0.0001]))
                           
    MODIS_859 = (26, 0.8150, 0.9000, 
                 np.array([0.0000, 0.0000, 0.0105, 
                           0.0232, 0.0453, 0.0829, 
                           0.1323, 0.2033, 0.2973, 
                           0.4523, 0.6467, 0.8257, 
                           0.9677, 0.9946, 0.9851, 
                           0.9722, 0.9667, 0.9689, 
                           0.9661, 0.9816, 0.9811, 
                           0.9621, 0.9107, 0.7945, 
                           0.6330, 0.4013, 0.2012, 
                           0.1081, 0.0592, 0.0416, 
                           0.0311, 0.0247, 0.0191, 
                           0.0137, 0.0000]))
                           
    MODIS_869 = (27, 0.8400, 0.8900, 
                 np.array([0.0005, 0.0011, 0.0020, 
                           0.0040, 0.0077, 0.0186, 
                           0.0836, 0.2824, 0.5977, 
                           0.8795, 0.9994, 0.9767, 
                           0.9450, 0.7596, 0.4792, 
                           0.1482, 0.0275, 0.0099, 
                           0.0047, 0.0023, 0.0011]))
                           
    MODIS_1240 = (28, 1.2120, 1.2710, 
                  np.array([0.0000, 0.0140, 0.0265, 
                            0.0495, 0.0930, 0.1748, 
                            0.3041, 0.4700, 0.6621, 
                            0.8248, 0.9308, 0.9835, 
                            0.9897, 0.9830, 0.9093, 
                            0.7926, 0.6123, 0.3883, 
                            0.2229, 0.1235, 0.0594, 
                            0.0380, 0.0213, 0.0129])
                            )
    MODIS_1640 = (29, 1.5950, 1.6600, 
                  np.array([0.0000, 0.0151, 0.0260, 
                            0.0459, 0.0818, 0.1474, 
                            0.2512, 0.3926, 0.5517, 
                            0.7203, 0.8808, 0.9842, 
                            0.9933, 0.9775, 0.9629, 
                            0.9292, 0.8643, 0.7488, 
                            0.6036, 0.4570, 0.3358, 
                            0.2236, 0.1174, 0.0623, 
                            0.0401, 0.0262,0]))
                            
    MODIS_2130 = (30, 2.0570, 2.1750, 
                  np.array([0.0000, 0.0106, 0.0146, 
                            0.0199, 0.0289, 0.0406, 
                            0.0606, 0.0869, 0.1347, 
                            0.1987, 0.2891, 0.3986, 
                            0.5211, 0.6533, 0.7702, 
                            0.8758, 0.9392, 0.9717, 
                            0.9896, 0.9969, 0.9762, 
                            0.9348, 0.9040, 0.8808, 
                            0.8489, 0.8106, 0.7702, 
                            0.7282, 0.6905, 0.6561, 
                            0.6186, 0.5788, 0.5399, 
                            0.5017, 0.4568, 0.4071, 
                            0.3520, 0.2931, 0.2346, 
                            0.1763, 0.1303, 0.0931, 
                            0.0666, 0.0480, 0.0340, 
                            0.0232, 0.0157, 0.0109]))
...
def PredefinedWavelengthCenter(predef_wls):
    """
    Calculate center wavelength for predef_wls
    if id >0 then convolution performed
    """
    if predef_wls[0]>0:
        filt = predef_wls[3]
        wls = np.arange(len(filt))*0.0025+predef_wls[1]
        center_wl = np.trapz(filt*wls,x=wls) / np.trapz(filt,x=wls)
    else:
        center_wl = 0.5*(predef_wls[1]+predef_wls[2])
    return center_wl